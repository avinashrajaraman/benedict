(function(){
        ...
        var assetsLoader = function(){
                ...
                this.imgs = {
                        ...
                        "deadEgg" : "./Sprites/Benedict/death.png",
                        "maze1" : "./Maze1/maze.png"
        ...
        var egg = function(player){
                ...
                player.spritesheetDead = new SpriteSheet(
                                assetsLoader.imgs['deadEgg'],
                                50,
                                200
                                );
        /*
...
*/
                ...
                player.deadSprite = new Animation(player.spritesheetDead,7,0,3);
                ...
                player.update = function(){
                        ...
                        if(time * 30/1000 > 35){
                                player.dead = true;
                                player.anim = player.deadSprite;
                                ctx.font = "15px Verdana";
                                ctx.fillStyle = "white";
                                ctx.fillText("GAME OVER EXCEEDED TIME",100,100)
                        }
                        else {
                        if (KEY_STATUS.right){
...
*/
                ...
                else if (egg.x - ((i-1)*tileWidth + tileWidth)<= egg.radius && obstacleColors.indexOf(map.getAt(i-1,j))>=0){
    ...
    function animate(){
                ...
                ctx.font = "15px Verdana";
                ctx.fillStyle = "white";
                ctx.fillText("Finish it ! Time running out " + time*30/1000,100,15)
    ...
    function startGame(){
                ...
                map = parseMap(assetsLoader.imgs["maze1"]);
                loadMap(map);
                for(var i =0;i<terrain.length;i++){
